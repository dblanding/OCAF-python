...
# create a label with tag 1 under root
lab1 = root.FindChild(1)
print(f"lab1 label has entry [{get_entry(lab1)}]")

# Any attributes attached to lab1?
nb_att = lab1.NbAttributes()
print(f"Label lab1 has {nb_att} attribute(s) attached")

# attach an integer attribute to lab1
INT = TDataStd_Integer()
lab1.AddAttribute(INT)
attach = INT.Label()

# Any attributes attached to lab1 now?
nb_att = lab1.NbAttributes()
print(f"Label lab1 has {nb_att} attribute(s) attached")
